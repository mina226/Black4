...
if MsgText[1] == 'المممممممممططططططططوووووووررررررررر' then
...
❍ يوجد بي العديد من المميزات مثل الافلام والكرتون والاغاني والروايات والقران والعديد من المميزات الاخري
]]
else
text = [[❍ أهلاً انا بوت    []]..redis:get(black..':NameBot:')..[[] 🗽
❍ أختصاصي حماية المجموعات ..
