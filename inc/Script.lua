...
elseif Text== "اي" then return sendMsg(msg.chat_id_,msg.id_,"اي يقلبي")
...
elseif Text== "تمام" then return sendMsg(msg.chat_id_,msg.id_," لا انا مش مرضي انا عاوز حقي")
elseif Text== "احا" then return sendMsg(msg.chat_id_,msg.id_,"افتحها")
elseif Text== "هيا اي" then return sendMsg(msg.chat_id_,msg.id_,"مش هقول")
